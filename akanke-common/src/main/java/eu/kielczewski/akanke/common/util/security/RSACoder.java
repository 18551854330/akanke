package eu.kielczewski.akanke.common.util.security;
...
public final class RSACoder {
	...
	public static boolean verify(String data, String publicKey, String sign) {
		return verify(StringUtils.getBytesUtf8(data), Base64.getDecoder()
				.decode(publicKey), Base64.getDecoder().decode(sign));
	}
